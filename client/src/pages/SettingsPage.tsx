  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E2E6E4] space-y-4 shadow-card">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono">
            <div className="p-3.5 rounded-xl bg-[#F7F8F7] border border-[#E2E6E4]">
              <span className="text-[#6B7471] block text-[10px]">NAME</span>
              <span className="text-[#202524] font-bold">{user?.name || 'Dev Architect'}</span>
            </div>
            <div className="p-3.5 rounded-xl bg-[#F7F8F7] border border-[#E2E6E4]">
              <span className="text-[#6B7471] block text-[10px]">EMAIL</span>
              <span className="text-[#1F5E4B] font-bold">{user?.email || 'developer@moduleforge.io'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E2E6E4] space-y-4 shadow-card">
          <h2 className="text-base font-bold text-[#202524] flex items-center gap-2">
            <Database className="w-5 h-5 text-[#1F5E4B]" />
            <span>Services & Infrastructure</span>
          </h2>

          <div className="space-y-3 text-xs font-mono">
            <div className="p-3.5 rounded-xl bg-[#F7F8F7] border border-[#E2E6E4] flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <Database className="w-4 h-4 text-[#1F5E4B]" />
                <span className="text-[#202524]">Database Engine</span>
              </div>
              <span className="px-2.5 py-1 rounded bg-[#EAF3EF] text-[#1F5E4B] border border-[#1F5E4B]/20 font-bold">
            ...
            <div className="p-3.5 rounded-xl bg-[#F7F8F7] border border-[#E2E6E4] flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <Zap className="w-4 h-4 text-[#2E7D5B]" />
                <span className="text-[#202524]">Authentication Provider</span>
              </div>
              <span className="px-2.5 py-1 rounded bg-[#F0F9F5] text-[#2E7D5B] border border-[#2E7D5B]/20 font-bold">
                Local Dev Mode Session
              </span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-[#F7F8F7] border border-[#E2E6E4] flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[#202524]">Module Storage</span>
              </div>
              <span className="px-2.5 py-1 rounded bg-[#EAF3EF] text-[#1F5E4B] border border-[#1F5E4B]/20 font-bold">
            ...
            <div className="p-3.5 rounded-xl bg-[#F7F8F7] border border-[#E2E6E4] flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[#202524]">Target AI Coding Agent</span>
              </div>
              <span className="px-2.5 py-1 rounded bg-[#EAF3EF] text-[#1F5E4B] border border-[#1F5E4B]/20 font-bold">
